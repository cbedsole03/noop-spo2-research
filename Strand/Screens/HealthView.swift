...
private struct VitalsSection: View {
    ...
    // #103: firmware-specific SpO₂ candidate means, loaded when the experimental toggle is ON.
    // Empty when the toggle is OFF or no candidate data exists for the selected firmware layout.
    ...
    var body: some View {
        ...
        .task(id: PuffinExperiment.spo2CandidateDisplayEnabled) {
            ...
            // #103: load the firmware-specific SpO₂ candidate means when the toggle is ON.
            ...
            // is OFF (the engine writes nothing) or no in-band candidate was captured.
